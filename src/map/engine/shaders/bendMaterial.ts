...
// bendWorld() before view/projection. Materials patched this way share ONE
// uniform set, so updating the uniforms once per frame moves everything.
...
export function applyBendToMaterial<M extends Material>(material: M, uniforms: BendUniforms): M {
  ...
  material.customProgramCacheKey = () => "himinrond-bend-v1";
