...
import { isLanguage, resolveLanguage, type Language } from "@/i18n/language";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">{t("errors.failed.body")}</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Himinrond" },
      { name: "description", content: "Himinrond — himmelens rand." },
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html:
              'try{var t=localStorage.getItem("himinrond.theme");if(t==="light"){document.documentElement.setAttribute("data-theme","light")}else{document.documentElement.removeAttribute("data-theme")}}catch(e){}',
          }}
        />
        <HeadContent />
      </head>
